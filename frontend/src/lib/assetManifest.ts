...
function loadInlineManifest(): AssetDef[] {
  return [
    // === PARAMETRIC: Conveyors ===
    {
      ...
      parts: {},
      thumbnailUrl: '',
      defaults: { width: 600, length: 3000, height: 800, angle: 0, beltSpeed: 20, sideGuides: true, driveEnd: 'right', supportSpacing: 1500 },
      limits: { width: [300, 1200], length: [500, 12000], height: [300, 3000], angle: [0, 35], beltSpeed: [1, 100], supportSpacing: [500, 3000] },
      parameterDefs: {
        ...
        angle: { type: 'number', label: 'Incline Angle', unit: '°', step: 1 },
    ...
    },
    {
      ...
      parts: {},
      thumbnailUrl: '',
      defaults: { width: 600, length: 3000, height: 800, rollerPitch: 100, driven: true, sideRails: true },
      limits: { width: [300, 1200], length: [500, 12000], height: [300, 3000], rollerPitch: [50, 200] },
      parameterDefs: {
        width: { type: 'number', label: 'Width', unit: 'mm', step: 50 },
        length: { type: 'number', label: 'Length', unit: 'mm', step: 100 },
        height: { type: 'number', label: 'Height', unit: 'mm', step: 50 },
        rollerPitch: { type: 'number', label: 'Roller Pitch', unit: 'mm', step: 10 },
        driven: { type: 'boolean', label: 'Powered Rollers' },
    ...
    },
    {
      ...
      parts: {},
      thumbnailUrl: '',
      defaults: { width: 600, length: 1500, height: 800, popupHeight: 200, speed: 1, direction: 'left' },
      limits: { width: [300, 1200], length: [500, 3000], height: [300, 1500], popupHeight: [100, 500], speed: [0.1, 5] },
      parameterDefs: {
        width: { type: 'number', label: 'Width', unit: 'mm', step: 50 },
        length: { type: 'number', label: 'Length', unit: 'mm', step: 100 },
        height: { type: 'number', label: 'Height', unit: 'mm', step: 50 },
        popupHeight: { type: 'number', label: 'Popup Height', unit: 'mm', step: 10 },
        speed: { type: 'number', label: 'Speed', unit: 'm/s', step: 0.1 },
    ...
    },
    {
      ...
      parts: {},
      thumbnailUrl: '',
      defaults: { width: 600, length: 2000, height: 800, pushAngle: 90, pushForce: 1, pushSide: 'left' },
      limits: { width: [300, 1200], length: [500, 4000], height: [300, 1500], pushAngle: [30, 180], pushForce: [0.1, 5] },
      parameterDefs: {
        width: { type: 'number', label: 'Width', unit: 'mm', step: 50 },
        length: { type: 'number', label: 'Length', unit: 'mm', step: 100 },
        height: { type: 'number', label: 'Height', unit: 'mm', step: 50 },
    ...
    // === PARAMETRIC: Spiral Conveyor ===
    {
      ...
      parts: {},
      thumbnailUrl: '',
      defaults: { diameter: 2000, totalHeight: 5000, beltWidth: 500, direction: 'up', speed: 1 },
      limits: { diameter: [1000, 5000], totalHeight: [1000, 15000], beltWidth: [300, 1000], speed: [0.1, 5] },
      parameterDefs: {
    ...
    // === PARAMETRIC: Vertical Lifter ===
    {
      ...
      parts: {},
      thumbnailUrl: '',
      defaults: { platformWidth: 1000, platformDepth: 1000, liftHeight: 3000, speed: 1, loadDirection: 'front', capacity: 4 },
      limits: { platformWidth: [500, 2000], platformDepth: [500, 2000], liftHeight: [500, 10000], speed: [0.1, 5], capacity: [1, 20] },
      parameterDefs: {
