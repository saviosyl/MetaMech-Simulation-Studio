...
export const moduleLibrary: ModuleDefinition[] = [
  ...
  },
  {
    ...
    category: 'process',
    icon: ArrowUpDown,
    description: 'Vertical conveyor for product elevation changes',
    ...
    parameters: {
      ...
      infeedHeight: { type: 'number', label: 'Infeed Height (mm)', default: 0, min: 0, max: 10000, step: 100 },
      outfeedHeight: { type: 'number', label: 'Outfeed Height (mm)', default: 3000, min: 0, max: 10000, step: 100 },
      ...
      fenceEnabled: { type: 'boolean', label: 'Fence / Guarding', default: true },
  ...
  // Environment Modules
  {
    ...
    parameters: {
      ...
      textureUrl: { type: 'text', label: 'Wall Image / Logo (URL)', default: '' },
      wallImageMode: { type: 'select', label: 'Image Mode', default: 'pattern', options: ['pattern', 'decal'] },
      wallImageOpacity: { type: 'number', label: 'Image Opacity', default: 1, min: 0, max: 1, step: 0.05 },
      wallPatternRepeatX: { type: 'number', label: 'Pattern Repeat X', default: 5, min: 0.1, max: 40, step: 0.1 },
      wallPatternRepeatY: { type: 'number', label: 'Pattern Repeat Y', default: 3, min: 0.1, max: 40, step: 0.1 },
      wallLogoWidth: { type: 'number', label: 'Logo Width (mm)', default: 1200, min: 100, max: 20000, step: 50 },
      wallLogoHeight: { type: 'number', label: 'Logo Height (mm)', default: 600, min: 50, max: 10000, step: 25 },
      wallLogoKeepAspect: { type: 'boolean', label: 'Keep Logo Aspect', default: true },
      wallLogoOffsetX: { type: 'number', label: 'Logo Offset X (mm)', default: 0, min: -20000, max: 20000, step: 25 },
      wallLogoOffsetY: { type: 'number', label: 'Logo Offset Y (mm)', default: 0, min: -10000, max: 10000, step: 25 },
      wallLogoRotation: { type: 'number', label: 'Logo Rotation (deg)', default: 0, min: -180, max: 180, step: 1 },
