...
export const moduleLibrary: ModuleDefinition[] = [
  ...
  },
  {
    ...
    parameters: {
      ...
      stopperMode: { type: 'select', label: 'Mode', default: 'timed-release', options: ['timed-release', 'timed-batch', 'sensor-release', 'external-trigger', 'pulse-open', 'downstream-clear'] },
      ...
      openDuration: { type: 'number', label: 'Open Duration (sec)', default: 2, min: 0.1, max: 30, step: 0.5 },
      sensorTag: { type: 'text', label: 'Sensor Tag (for sensor-release)', default: '' },
