...
function groupParams(params: [string, any][]) {
  ...
  const logK = ['stopperMode','pusherMode','holdTime','releaseCount','openDuration','sensorTag','sensorType','detectColor','showBeam','mountPosition','mountHeight','engaged','enabled','targetColor','targetProductType','routeBy','routeValues','stroke','side'];
